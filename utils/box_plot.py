...
value0 =  [df_ERM.iloc[42][2], df_Context.iloc[42][2], df_Rotation.iloc[42][2], df_Affine.iloc[42][2], df_Jigsaw.iloc[42][2]]
...
d = {'Method': key0 + key1 + key2 + key3 + key4 +key5, 'acc': value0+value1 +value2+value3+value4+value5, "skew": skew0+skew1+skew2+skew3+skew4+skew5}
